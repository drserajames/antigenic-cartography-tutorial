...
pc <- procrustesMap(map_from_map_rfm2, map_from_map_rm2, 1, 2)
view(pc)
```
...
If they are technical replciates (i.e. the same serum sample, titrated more than one), then I would recommend merging before antigenic cartography (assuming that the replicates are sufficiently similar).
